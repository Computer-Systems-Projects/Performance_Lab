...
#My results
reduced CPE to 16, showing a massive increase in performance utilizing loop unrolling with separate accumalators, resizing data, optimizing data for cache performance, and reducing function calls inside of loops.
## Introduction
